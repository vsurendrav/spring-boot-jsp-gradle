   ...
   // @Test
    ...
    static class ContextConfiguration {
        ...
        public BookRepository provideBookRepository() {
            return null;//new InMemoryBookRepository(initialBookData());
        }

		/*
		 * private static Map<String, BookData> initialBookData() { // Map<String,
		 * BookData> initData = new HashMap<>(); //initData.put("ISBN-TEST-1", new
		 * BookData("ISBN-TEST-1", "Book 1", "Book 1 Author"));
		 * //initData.put("ISBN-TEST-2", new BookData("ISBN-TEST-2", "Book 2",
		 * "Book 2 Author")); //initData.put("ISBN-TEST-3", new BookData("ISBN-TEST-3",
		 * "Book 3", "Book 3 Author")); // return initData; }
		 */
    }
}